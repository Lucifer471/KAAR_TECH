...
connection_url = 'mongodb+srv://Rishi_AB:Rishiv2k@cluster0.x1ku8vn.mongodb.net/?retryWrites=true&w=majority'
app = Flask(__name__)
client = pymongo.MongoClient(connection_url)


Database = client.get_database('DEMO_DB')

SampleTable = Database.DEMO
